...
@m_inode = common dso_local global %union.pthread_mutex_t zeroinitializer, align 8
@inode = common dso_local global i32 0, align 4
@m_busy = common dso_local global %union.pthread_mutex_t zeroinitializer, align 8
