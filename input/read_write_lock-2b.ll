; ModuleID = 'read_write_lock-2b.c'
source_filename = "read_write_lock-2b.c"
...
@.str.1 = private unnamed_addr constant [21 x i8] c"read_write_lock-2b.c\00", align 1
...
define dso_local void @reach_error() #0 {
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), i32 7, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__PRETTY_FUNCTION__.reach_error, i64 0, i64 0)) #6
  unreachable
}
